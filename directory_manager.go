...
// DirectoryManager provides safe filesystem operations within a specific directory
...
// Exists checks if a file exists using Root.Stat
func (dm *DirectoryManager) Exists(filename string) bool {
	exists := false
